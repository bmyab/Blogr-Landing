...
document.getElementById("nav-toggle").addEventListener("click", () => {
  ...
  if (nav_toggle) {
    ...
    icon_navbar.src = "assets/images/icon-hamburger.svg";
  } else {
...
window.onload = function () {
  if (screen.width < 1000) {
    ...
    arrows_imgs[0].src = "assets/images/icon-arrow-dark.svg";
    arrows_imgs[1].src = "assets/images/icon-arrow-dark.svg";
    arrows_imgs[2].src = "assets/images/icon-arrow-dark.svg";
  }
};
